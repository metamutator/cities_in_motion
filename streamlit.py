...
st.subheader("Islandwide Taxi Demand")
...
# st.subheader("Most & Least Covid-Impacted Districts")
...
def taxigraph(dataset, region, hour, startdate, enddate):
    ...
    basedata['moving_average'] = basedata.taxi_count.rolling(30).mean()
    return basedata
...
with row61:
    ...
    fig1 = px.line(district_1_data, x='filename', y=['taxi_count', 'moving_average'],
                   labels={"filename": "Time", "value": "Taxi Count"},
                   title=f'Taxi Demand in {selected_district_1}')
...
with row62:
    ...
    fig2 = px.line(district_2_data, x='filename', y=['taxi_count', 'moving_average'],
                   labels={"filename": "Time","value": "Taxi Count"},
                   title=f'Taxi Demand in {selected_district_2}')
